package com.stratoscreen.utils
{
	...
	public class GUID extends Object {
		...
		public static function create(addDash:Boolean = true):String {
			var token:String = addDash ? "-" : "";
			...
			var finalString:String = rawID.substring(0, 8) + token + rawID.substring(8, 12) + token + rawID.substring(12, 16) + token + rawID.substring(16, 20) + token + rawID.substring(20, 32);
			return finalString;
		}
...
// http://snipplr.com/view.php?codeview&id=45247
